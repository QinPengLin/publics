...
// 瀑布流配置
METUI_FUN['product_list_page_met_21_6'] = {
    name:'product_list_page_met_21_6',
    metAnimOnScroll: function() {
        var list=METUI['product_list_page_met_21_6'].find('.met-product-list');
        // 产品列表页
        if(list.length){
            // 图片懒加载
            var $metpro_original=METUI['product_list_page_met_21_6'].find(".met-product-list [data-original]");
            if($metpro_original.length){
                var $pro_fluid=METUI['product_list_page_met_21_6'].find(".met-product-list .container-fluid");
                if($pro_fluid.length){
                    $pro_fluid.each(function(){
                        var $self=$(this);
                        $(this).width($(this).width());
...
METUI['product_list_page_met_21_6'] = new metui(METUI_FUN['product_list_page_met_21_6']);
