...
METUI_FUN['product_list_detail_met_35_1'] = {
    name: 'product_list_detail_met_35_1',
    init: function() {
        var paddb = parseInt($(".product_list_detail_met_35_1 #met-imgs-slick.slick-dotted").attr("data-padh"))+10;
        $(".product_list_detail_met_35_1 #met-imgs-slick.slick-dotted").css("paddingBottom",paddb+"px");
        //原来的
        if (METUI['product_list_detail_met_35_1'].hasClass('pagetype2')) {
            var navbar = METUI['product_list_detail_met_35_1'].find('.navbar'),
            ...
            /*选项卡滚动条（移动端）*/
            METUI['product_list_detail_met_35_1'].find(' .navbar .navbar-toggle').one("click", function() {
                setTimeout(function() {
                    $(this).navtabSwiper();
                }, 0)
            });
...
var x = new metui(METUI_FUN['product_list_detail_met_35_1']);
