...
$LANG['avatar'] = '头像';
$LANG['promote_s'] = '推广状态';
$LANG['ispromote'] = '是否开启推广';
$LANG['promote_point'] = '单次推广获取积分';
$LANG['promote_point_sm'] = '最低1积分';
$LANG['grow_info'] = '成长信息';
