<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><div class="col-left col-1 left-memu">
            ...
            <?php if($memberinfo['promote_s']==1) { ?>
                <li <?php if(ROUTE_A=="promote") { ?> class="on"<?php } ?>><a href="index.php?m=member&c=index&a=promote"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="14" height="16" /> <?php echo L('promote');?></a></li>
            <?php } ?>
            </ul>
