...
//URL地址
$url='news/index/'.$cid;
$sqlstr = "select {field} from ".CS_SqlPrefix."news where yid=0 and uid=".$_SESSION['mscms__id'];
if($cid>0){
$cids=getChild($cid);
...
//URL地址
$url='news/verify/'.$cid;
$sqlstr = "select {field} from ".CS_SqlPrefix."news where yid=1 and uid=".$_SESSION['mscms__id'];
if($cid>0){
$cids=getChild($cid);
$sqlstr.= " and cid in(".$cids.")";
}
