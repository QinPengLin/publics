...
class Apiku extends mscms_Controller {
...
$data['api']='http://vod.msvod.cc/api/mscms_zy_4.x.js?'.rand(1000,9999);
...
$str=implode('#mscms#',array_merge($old,$news));
return $str;
}
}
?>