...
msg_url('这部视频下载每集需要'.$row['dcion'].'个金币，您的当前金币不够，请先充值！','javascript:window.close();');
}else{
//扣币
