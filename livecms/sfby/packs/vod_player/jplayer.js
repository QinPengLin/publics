...
function getjp_play() {
	if(jpurl.indexOf(".m4a")>0){
		$("#mscms_jplayer").jPlayer("setMedia", {m4a:jpurl}).jPlayer("play");
	}else{
		$("#mscms_jplayer").jPlayer("setMedia", {mp3:jpurl}).jPlayer("play");
	}
}
