...
$(function() {
  for (var i = 0; i < $("div[name=ee]").length; i++) {
            ...
            if (m.text().length > 170) {
                m.attr("ee", m.text());
                m.html(m.text().substr(0, 170) + "...<a onClick=\"zan();\" name=\"zhankai\" class=\"y\" href=\"javascript:;\">Õ¹¿ª</a>");
            }
  }
});
function zan(){
    var eh = $(".ee").attr("ee");
    $('.ee').html(eh + "<a onClick=\"guan();\" name=\"yinchang\" class=\"y\" href=\"javascript:;\">Òþ²Ø</a>");
}
function guan(){
    var eh = $(".ee").attr("ee");
    eh = eh.substr(0, 170);
    $('.ee').html(eh + "...<a onClick=\"zan();\" name=\"zhankai\" class=\"y\" href=\"javascript:;\">Õ¹¿ª</a>");
}
$(function(){
    $(".sbtn").click(function(){
...
function Order(o,id,vi){
    ...
    if (o==1){
      ...
      s1="<em class=\"over\">µ¹Ðò¡ý</em>"
      s2="<em onclick=\"Order(0,'vlink_"+vi+"',"+vi+")\">Ë³Ðò¡ü</em>"
    }else{
      for(i=leng-1;i>=0;i--){
          if(i==0){isno='<li class="new">';}else{isno='<li>';}
          uhtml+=isno+tag[i].innerHTML+"</li>";
      }
      s1="<em onclick=\"Order(1,'vlink_"+vi+"',"+vi+")\">µ¹Ðò¡ý</em>"
      s2="<em class=\"over\">Ë³Ðò¡ü</em>"
    }
    $$(id+"_s1").innerHTML=s1;
    $$(id+"_s2").innerHTML=s2;
    uhtml="<ul>"+uhtml+"</ul>";
