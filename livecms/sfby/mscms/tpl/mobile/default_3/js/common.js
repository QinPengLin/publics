...
m.attr("ee", m.text());
m.html(m.text().substr(0, 170) + "...<a onClick=\"zan();\" name=\"zhankai\" class=\"y\" href=\"javascript:;\">展开</a>");
}
}
});
function zan(){
var eh = $(".ee").attr("ee");
$('.ee').html(eh + "<a onClick=\"guan();\" name=\"yinchang\" class=\"y\" href=\"javascript:;\">隐藏</a>");
}
function guan(){
var eh = $(".ee").attr("ee");
eh = eh.substr(0, 170);
$('.ee').html(eh + "...<a onClick=\"zan();\" name=\"zhankai\" class=\"y\" href=\"javascript:;\">展开</a>");
}
$(function(){
$(".sbtn").click(function(){
