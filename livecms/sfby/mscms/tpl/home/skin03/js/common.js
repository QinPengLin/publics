...
var home = {
        init: function(){
              ...
              $('.seh_b').click(function() {
	              ...
	              var url=mscms_path+"index.php/"+dir+"/search?key="+encodeURIComponent(key);
	              window.open(url);
                  }
              });
        ...
        fav: function(uid,sid){
            ...
            if(!!otherDIds){
                $.getJSON(mscms_path+"index.php/home/ajax/favinit?did="+otherDIds+"&callback=?",function(res1){
                    followBtns.each(function(){
        ...
        favadd: function(did){
            $.getJSON(mscms_path+"index.php/home/ajax/fav/"+did+"?random="+Math.random()+"&callback=?",function(data) {
                      if(data['error']=='ok'){ //成功
        ...
        fans: function(uid,sid){
            ...
            if(!!otherUserIds){
                $.getJSON(mscms_path+"index.php/home/ajax/fansinit?uid="+otherUserIds+"&callback=?",function(res1){
                    followBtns.each(function(){
	...
	fansadd: function(uid,sid){
              $.getJSON(mscms_path+"index.php/home/ajax/fans/"+uid+"/"+sid+"?random="+Math.random()+"&callback=?",function(data) {
        ...
        zan: function(uid){
            $.getJSON(mscms_path+"index.php/home/ajax/zan/"+uid+"?random="+Math.random()+"&callback=?",function(data) {
                      if(data['error']=='ok'){ //成功
