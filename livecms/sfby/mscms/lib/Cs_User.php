...
define('User_Downcion',3);     //默认分成比列数量  
...
define('User_Reg_Name','创始人,管理员,版主,斑竹,mscms,487039015');  //禁用用户名/昵称 
...
define('User_RegEmailContent','尊敬的{mscms:user}，&lt;br/&gt;欢迎你注册成为{mscms:webname}的会员！&lt;br/&gt;请点击下面的链接进行帐号的激活：&lt;br/&gt;{mscms:url}&lt;br/&gt;如果不能点击链接，请复制到浏览器地址输入框访问。&lt;br/&gt;&lt;br/&gt;{mscms:webname}&lt;br/&gt;{mscms:time}'); //注册激活邮件内容
define('User_RegMsgContent','尊敬的{mscms:user}，&lt;br/&gt;欢迎你注册成为{mscms:webname}的会员！&lt;br/&gt;&lt;br/&gt;本站全体管理人员向您问好！&lt;br/&gt;{mscms:webname}'); //欢迎邮件内容不够
define('User_PassContent','尊敬的{mscms:user}，这是来自{mscms:webname}的密码重置邮件。点击下面的链接重置您的密码：&lt;br/&gt;{mscms:url}&lt;br/&gt;二小时内有效，如非本人操作，请忽略，&lt;br/&gt;如果链接无法点击，请将链接粘贴到浏览器的地址栏中访问。&lt;br/&gt;{mscms:webname} &lt;br/&gt;{mscms:time}');  //密码找回邮件内容
...
define('User_Cion_Reg',5);      //注册赠送金币  
define('User_Cion_Log',1);      //登入赠送金币  
define('User_Cion_Qd',10);      //签到赠送金币
define('User_Cion_Logo',5);      //上传头像赠送金币
define('User_Cion_Add',10);      //发表数据赠送金币
define('User_Cion_Zx',5);      //在线1小时赠送金币
define('User_Cion_Del',5);      //数据删除扣除金币
...
define('User_Cion_Share',10);      //每次分享奖励金币
define('User_Jinyan_Share',10);      //每次分享奖励经验
define('User_Nums_Share',10);      //每天分享奖励次数
define('User_Nums_Add',10);      //每天发表数据奖励次数
define('User_Cion_ticheng',10);      //代理充值提成
define('User_Skins','default_2/mcheng_html/');      //会员默认模板路径