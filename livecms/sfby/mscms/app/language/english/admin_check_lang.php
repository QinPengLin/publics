<?php
//øÿ÷∆∆˜
$lang['plub_01']	= 'The system configuration is not reasonable, the post_max_size value must be greater than upload_max_filesize, otherwise there will be "progress bar 100% stuck", solution£∫<a style="color:red" target="_blank" href="http://bbs.msvod.cc/show/1.html">Here</a>';
$lang['plub_02']	= 'The system environment is only allowed to upload the%sMB file, you can set the upload_max_filesize value increased upload size, solution£∫<a style="color:red" target="_blank" href="http://bbs.msvod.cc/show/1.html">Here</a>';
$lang['plub_03']	= 'The system environment requires time to publish content of not more than%sMB (including file), can set the post_max_size value increased release of size, solution£∫<a style="color:red" target="_blank" href="http://bbs.msvod.cc/show/1.html">Here</a>';
