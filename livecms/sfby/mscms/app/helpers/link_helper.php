...
$Mark_Text=preg_replace('/\{mscms:pagenum(.*?)\}/','{mscms:pagenum}',$Mark_Text);
$Mark_Text=str_replace('{mscms:pagedata}',$Arr[10],$Mark_Text);
$Mark_Text=str_replace('{mscms:pagedown}',$Arr[4],$Mark_Text);
$Mark_Text=str_replace('{mscms:pagenow}',$Arr[5],$Mark_Text);
$Mark_Text=str_replace('{mscms:pagecout}',$Arr[6],$Mark_Text);
$Mark_Text=str_replace('{mscms:pagelist}',$Arr[9],$Mark_Text);
$Mark_Text=str_replace('{mscms:pagesize}',$Arr[7],$Mark_Text);
$Mark_Text=str_replace('{mscms:pagefirst}',$Arr[1],$Mark_Text);
$Mark_Text=str_replace('{mscms:pageup}',$Arr[3],$Mark_Text);
$Mark_Text=str_replace('{mscms:pagenum}',$Arr[8],$Mark_Text);
$Mark_Text=str_replace('{mscms:pagelast}',$Arr[2],$Mark_Text);	
return $Mark_Text;
}
//获取分页数目	
function getpagenum($Mark_Text){
preg_match('/\{mscms:(pagenum)\s*([a-zA-Z=]*)\s*([\d]*)\}/',$Mark_Text,$pagearr);
if(!empty($pagearr)){
if(trim($pagearr[3])!=""){
$pagenum=$pagearr[3];
}else{
...
for($i=1;$i<=$pagejs;$i++){
if($i==$pages){
$str.="<li class='active'><a href='".linkurl($fid,$sort,$id,$i)."'>".$i."</a></li>";
}else{
$str.="<li class='PageNo'><a href='".linkurl($fid,$sort,$id,$i)."'>".$i."</a></li>";
}
}
}else{
if($pages>=$pagenum){
...
if($i<=$pagejs){ 
$str.="<li class='PageNo'><a href='".linkurl($fid,$sort,$id,$pagejs)."'>".$pagejs."</a></li>";
}
}else{
for($i=1;$i<=$pagenum;$i++){
if($i==$pages){
$str.="<li class='active'><a href='".linkurl($fid,$sort,$id,$i)."' class='on'>".$i."</a></li>";
}else{
$str.="<li class='PageNo'><a href='".linkurl($fid,$sort,$id,$i)."'>".$i."</a></li>";
}
} 
