...
class Open extends Mscms_Controller {
...
$Mark_Text=str_replace("{mscms:title}",L('open_08')." - ".Web_Name,$template);
...
$add['useragent']=$agent;
$this->CsdjDB->get_insert('user_log',$add);
$_SESSION['mscms__id']    = $res;
$_SESSION['mscms__name']  = $username;
$_SESSION['mscms__zid']  = $userzid;
$_SESSION['mscms__cion']  = $usercion;
$_SESSION['mscms__login'] = md5($username.$user['pass']);
//记住登录
