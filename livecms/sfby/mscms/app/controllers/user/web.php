...
class Web extends Mscms_Controller {
...
$bgpic=getzd('user','bgpic',$_SESSION['mscms__id']);
//删除原来的图片
...
echo '<script type="text/javascript" src="'.Web_Path.'packs/js/mscms.js"></script><script type="text/javascript">
