...
class Uc extends Mscms_Controller
{
...
if(!isset($_SESSION['mscms__id']) || $_SESSION['mscms__id']!=$row->id){
...
$cachefile = MSCMSPATH.'uc_client/data/cache/badwords.php';
@unlink($cachefile);
return self::API_RETURN_SUCCEED;
}
...
$cachefile = MSCMSPATH.'uc_client/data/cache/hosts.php';
@unlink($cachefile);
return self::API_RETURN_SUCCEED;
}
...
$cachefile = MSCMSPATH.'uc_client/data/cache/apps.php';
@unlink($cachefile);
return self::API_RETURN_SUCCEED;
}
...
$cachefile = MSCMSPATH.'uc_client/data/cache/settings.php';
@unlink($cachefile);
return self::API_RETURN_SUCCEED;
}
...
{
require MSCMSPATH.'uc_client/lib/xml.class.php';
}
