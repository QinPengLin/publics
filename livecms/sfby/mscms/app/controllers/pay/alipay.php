...
class Alipay extends Mscms_Controller {
...
require_once(MSCMSPATH."pay/alipay_wap/alipay.config.php");
require_once(MSCMSPATH."pay/alipay_wap/lib/alipay_submit.class.php");
$format = "xml";
$v = "2.0";
$req_id = date('Ymdhis');
...
$subject = L('pay_03',array($_SESSION['mscms__name']));
$total_fee = $row->rmb;
...
require_once(MSCMSPATH."pay/alipay_trade/alipay.config.php");
require_once(MSCMSPATH."pay/alipay_trade/lib/alipay_submit.class.php");
$payment_type = "1";
$notify_url = site_url("pay/alipay/notify_url");
...
require_once(MSCMSPATH."pay/alipay_direct/alipay.config.php");
require_once(MSCMSPATH."pay/alipay_direct/lib/alipay_submit.class.php");
$payment_type = "1";
$notify_url = site_url("pay/alipay/notify_url");
$return_url = site_url("pay/alipay/return_url");
$seller_email = CS_Alipay_Name;
...
$beiz=L('pay_05').$_SESSION['mscms__name']."\r".L('pay_06').$row->dingdan;
echo '
...
require_once(MSCMSPATH."pay/alipay_wap/alipay.config.php");
require_once(MSCMSPATH."pay/alipay_wap/lib/alipay_notify.class.php");
...
require_once(MSCMSPATH."pay/alipay_trade/alipay.config.php");
require_once(MSCMSPATH."pay/alipay_trade/lib/alipay_notify.class.php");
//计算得出通知验证结果
$alipayNotify = new AlipayNotify($alipay_config);
$verify_result = $alipayNotify->verifyReturn();
if($verify_result) {//验证成功
...
require_once(MSCMSPATH."pay/alipay_direct/alipay.config.php");
require_once(MSCMSPATH."pay/alipay_direct/lib/alipay_notify.class.php");
$alipayNotify = new AlipayNotify($alipay_config);
$verify_result = $alipayNotify->verifyReturn();
if($verify_result) {//验证成功
//商户订单号
