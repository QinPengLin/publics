...
class Tenpay extends Mscms_Controller {
	...
	public function index()
	{
			...
			require_once(MSCMSPATH."pay/tenpay/RequestHandler.class.php");
        	...
        	$reqHandler->setParameter("body", L('pay_03',array($_SESSION['mscms__name'])));
        	$reqHandler->setParameter("bank_type", "DEFAULT");  	  //银行类型，默认为财付通
        	//用户ip
        	$reqHandler->setParameter("spbill_create_ip", getip());//客户端IP
        	$reqHandler->setParameter("fee_type", "1");               //币种
        	$reqHandler->setParameter("subject",L('pay_03',array($_SESSION['mscms__name'])));  //商品名称
        	//系统可选参数
	...
	public function return_url()
	{
	        ...
	        $partner = CS_Tenpay_ID;
            $key = CS_Tenpay_Key;
            require_once (MSCMSPATH."pay/tenpay/ResponseHandler.class.php");
	...
	public function notify_url()
	{
	    ...
	    $partner = CS_Tenpay_ID;
        $key = CS_Tenpay_Key;
        require (MSCMSPATH."pay/tenpay/ResponseHandler.class.php");
        require (MSCMSPATH."pay/tenpay/RequestHandler.class.php");
        require (MSCMSPATH."pay/tenpay/client/ClientResponseHandler.class.php");
        require (MSCMSPATH."pay/tenpay/client/TenpayHttpClient.class.php");
	    $resHandler = new ResponseHandler();
	    $resHandler->setKey($key);
	    if($resHandler->isTenpaySign()) {
