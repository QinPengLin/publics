...
$CS_wxpay_Name = trim($this->input->post('CS_wxpay_Name', TRUE));
$CS_jgpay_Name = trim($this->input->post('CS_jgpay_Name', TRUE));
...
$CS_Km = intval($this->input->post('CS_Km', TRUE));
$CS_Km_Url = trim($this->input->post('CS_Km_Url', TRUE));
$CS_Km_Pic = trim($this->input->post('CS_Km_Pic', TRUE));
$CS_Km_Key = trim($this->input->post('CS_Km_Key', TRUE));
$strs="<?php"."\r\n";
$strs.="define('CS_Alipay',".$CS_Alipay.");  //支付宝开关  \r\n";
$strs.="define('CS_Alipay_JK',".$CS_Alipay_JK.");  //支付宝接口,1为双功能接口，2为及时倒账，3为手动接口\r\n";
$strs.="define('CS_Alipay_Name','".$CS_Alipay_Name."');  //支付宝二维码  \r\n";
$strs.="define('CS_wxpay_Name','".$CS_wxpay_Name."');  //微信支付二维码  \r\n";
$strs.="define('CS_jgpay_Name','".$CS_jgpay_Name."');  //二维支付价格  \r\n";
...
$strs.="define('CS_Km',".$CS_Km.");  //卡密支付平台  \r\n";
$strs.="define('CS_Km_Url','".$CS_Km_Url."');  //电脑版卡密购买链接  \r\n";
$strs.="define('CS_Km_Pic','".$CS_Km_Pic."');  //手机版卡密购买链接  \r\n";
$strs.="define('CS_Km_Key','".$CS_Km_Key."');  //安全验效码KEY";
//写文件
if (!write_file(MSCMS.'lib/Cs_Pay.php', $strs)){
