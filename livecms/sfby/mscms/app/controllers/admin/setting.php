...
class Setting extends Mscms_Controller {
...
$Web_skin = $this->input->post('Web_skin', TRUE, TRUE);
$Flv_sc = $this->input->post('Flv_sc', TRUE, TRUE);
...
$Time_Sj = $this->input->post('Time_Sj', TRUE, TRUE);
$Pic_ksad = $this->input->post('Pic_ksad', TRUE, TRUE);
$Pic_ztad = $this->input->post('Pic_ztad', TRUE, TRUE);
$Pic_url = $this->input->post('Pic_url', TRUE, TRUE);
$Pic_lj = $this->input->post('Pic_lj', TRUE, TRUE);
$CS_Play_sw = $this->input->post('CS_Play_sw', TRUE, TRUE);
$CS_Play_sh = $this->input->post('CS_Play_sh', TRUE, TRUE);
$Ad_Kg = $this->input->post('Ad_Kg', TRUE, TRUE);
$CS_Play_AdloadTime = $this->input->post('CS_Play_AdloadTime', TRUE, TRUE);
...
$CS_Play_yk = intval($this->input->post('CS_Play_yk'));
$CS_Play_hy = intval($this->input->post('CS_Play_hy'));
...
$db_cof=read_file(FCPATH."mscms/lib/Cs_DB.php");
...
if(!write_file(FCPATH."mscms/lib/Cs_DB.php", $db_cof)){
admin_msg(vsprintf(L('setting_err_03'),array('./mscms/lib/Cs_DB.php')),site_url('setting'),'no');
}

$strs="<?php"."\r\n";
$strs.="define('Web_Name','".$Web_Name."'); //站点名称  \r\n";
$strs.="define('Web_skin','".$Web_skin."'); //网站风格  \r\n";
...
$strs.="define('Time_Sj','".$Time_Sj."');  //限制观看时间  \r\n";
$strs.="define('Pic_ksad','".$Pic_ksad."');  //播放前广告图片  \r\n";
$strs.="define('Pic_url','".$Pic_url."');  //播放前广告链接  \r\n";
$strs.="define('Pic_ztad','".$Pic_ztad."');  //暂停播放广告图片  \r\n";
$strs.="define('Pic_lj','".$Pic_lj."');  //暂停播放广告链接  \r\n";
$strs.="define('Ad_Kg','".$Ad_Kg."');  //关闭播放器广告  \r\n";
$strs.="define('CS_Play_AdloadTime','".$CS_Play_AdloadTime."');  //播放器广告时间  \r\n";
$strs.="define('W_k','".$W_k."');  //播放器宽度  \r\n";
$strs.="define('W_h','".$W_h."');  //播放器高度  \r\n";
...
$strs.="define('CS_Play_yk','".$CS_Play_yk."');  //游客    \r\n";
$strs.="define('CS_Play_hy','".$CS_Play_hy."');  //会员    \r\n";
$strs.="define('Web_Skins','".$Web_Skins."');  //默认主页模板路径     \r\n";
$strs.="define('Flv_sc','".$Flv_sc."');  //91FLV云端上传配置    ";
//写文件
if (!write_file(MSCMS.'lib/Cs_Config.php', $strs)){
...
//写文件
if (!write_file(MSCMS.'lib/Cs_Ftp.php', $strs)){
admin_msg(vsprintf(L('setting_err_02'),array('mscms/lib/Cs_Ftp.php')),site_url('setting/ftp'),'no');
}else{
...
//写文件
if (!write_file(MSCMS.'lib/Cs_Water.php', $strs)){
admin_msg(vsprintf(L('setting_err_02'),array('mscms/lib/Cs_Water.php')),site_url('setting/tb'),'no');
}else{
...
//写文件
if (!write_file(MSCMS.'lib/Cs_Denglu.php', $strs)){
admin_msg(vsprintf(L('setting_err_02'),array('mscms/lib/Cs_Denglu.php')),site_url('setting/denglu'),'no');
}else{
