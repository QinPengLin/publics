...
require_once MSCMS.'lib/Cs_Qiniu.php';
require_once MSCMS.'lib/Cs_Kpan.php';
require_once MSCMS.'lib/Cs_Oss.php';
require_once MSCMS.'lib/Cs_Upyun.php';
}
//上传方式
...
//修改配置文件
write_file(MSCMS.'lib/'.$files, $strs);
return true;
}
//判断删除方式
...
require_once MSCMSPATH.'uploads/qiniu/io.php';
require_once MSCMSPATH.'uploads/qiniu/rs.php';
...
require_once MSCMSPATH.'uploads/kdisk/kuaipan.class.php';
...
require_once MSCMSPATH.'uploads/oss/sdk.class.php';
$obj = new ALIOSS();
$dir=date('Ymd');
...
require_once MSCMSPATH.'uploads/upyun/upyun.class.php';
